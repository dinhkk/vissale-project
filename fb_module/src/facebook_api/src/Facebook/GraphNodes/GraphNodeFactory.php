...
class GraphNodeFactory {
	 ...
	 *        	The GraphNode sub class to cast to.
	 *        	
	 * @return GraphNode
	 *
	 ...
	 *
	 * @param string|null $subclassName
	 *        	The GraphNode sub class to cast the list items to.
	 * @param boolean $auto_prefix
	 *        	Toggle to auto-prefix the subclass name.
	 *        	
	 * @return GraphEdge
	 *
	 * @throws FacebookSDKException
	 ...
	 * @param string|null $subclassName
	 *        	The subclass to cast this collection to.
	 *        	
	 * @return GraphNode
	 *
	 * @throws FacebookSDKException
	 ...
	 *        	The key of this data (Graph edge).
	 * @param string|null $parentNodeId
	 *        	The parent Graph node ID.
	 *        	
	 ...
	 *        	The array of data to iterate over.
	 * @param string|null $subclassName
	 *        	The GraphNode subclass to cast each item in the list to.
	 * @param string|null $parentKey
	 *        	The key of this data (Graph edge).
	 * @param string|null $parentNodeId
	 *        	The parent Graph node ID.
	 ...
	 *        	The GraphNode subclass to validate.
	 *        	
	 * @throws FacebookSDKException
	 */
