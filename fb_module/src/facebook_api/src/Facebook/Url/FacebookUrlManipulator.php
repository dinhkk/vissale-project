...
class FacebookUrlManipulator {
	 ...
	 *        	The params to filter from the URL.
	 *        	
	 ...
	 *
	 * @param string $url
	 *        	The URL that will receive the params.
	 * @param array $newParams
	 *        	The params to append to the URL.
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param string $url
	 *        	The URL to parse the params from.
	 *        	
	 * @return array
	 */
	 ...
	 *
	 * @param string $urlToStealFrom
	 *        	The URL harvest the params from.
	 * @param string $urlToAddTo
	 *        	The URL that will receive the new params.
	 *        	
	 ...
	 *
	 * @param string $urlToTrim
	 *        	The URL the needs the surgery.
	 *        	
