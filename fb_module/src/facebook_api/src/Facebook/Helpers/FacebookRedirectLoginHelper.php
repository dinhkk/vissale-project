...
class FacebookRedirectLoginHelper {
	 ...
	 * @param PersistentDataInterface|null $persistentDataHandler
	 ...
	 *        	The URL Facebook should redirect users to after login.
	 * @param array $scope
	 *        	List of permissions to request during login.
	 * @param array $params
	 ...
	 *        	The access token that will be logged out.
	 * @param string $next
	 *        	The url Facebook should redirect the user to after a successful logout.
	 * @param string $separator
	 *        	The separator to use in http_build_query().
	 *        	
	 * @return string
	...
	public function getAccessToken($redirectUrl = null) {
		...
		$redirectUrl = FacebookUrlManipulator::removeParamsFromUrl ( $redirectUrl, [ 
				'state' 
		] );
