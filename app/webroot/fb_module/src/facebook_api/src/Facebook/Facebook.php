...
class Facebook {
	 ...
	 *        	The GraphEdge to paginate over.
	 *        	
	 ...
	 *        	The direction of the pagination: next|previous.
	 *        	
	 * @return GraphEdge|null
	 *
	 * @throws FacebookSDKException
	 ...
	 *
	 * @param int $target
	 *        	The id of the target node before the /videos edge.
	 * @param string $pathToFile
	 *        	The full path to the file.
	 * @param array $metadata
	 *        	The metadata associated with the video file.
	 * @param string|null $accessToken
	 *        	The access token.
	 * @param int $maxTransferTries
	 *        	The max times to retry a failed upload chunk.
	 * @param string|null $graphVersion
