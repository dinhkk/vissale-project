...
//        $fanpage_token_key = $this->getPageAccessToken($this->pageData, $this->groupData, false);
    ...
    private function _chat_comment(&$comment, &$message, $attachment_url=null)
    {
        ...
        $commentId = $this->_getDB()->createCommentPostV2($comment['group_id'], $comment['page_id'], $comment['fb_page_id'], $comment['post_id'], $comment['fb_post_id'], $comment['page_id'], $replied_comment_id, $comment['id'], $comment['comment_id'], $message, $attachment_url , $fb_customer_id, time());
