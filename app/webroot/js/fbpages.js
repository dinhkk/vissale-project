$(function() {
	...
	$(document).on('click', '#btnSaveConfig', function() {
		...
		var fb_app_version = $('#fb_app_version').val();
		...
		var post_data = {reply_comment_has_phone:reply_comment_has_phone,reply_comment_nophone:reply_comment_nophone,is_like:is_like,
			...
			fb_app_id:fb_app_id,fb_app_secret_key:fb_app_secret_key,fb_app_version:fb_app_version,user_coment_filter:user_coment_filter
		};
