$(function() {
	...
	$(document).on('click', '#btnSaveConfig', function() {
		var targeturl = 'http://fbsale.dinhkk.com/FBPage/updateConfig';
	...
	$(document).on('click','.btnRemovePage',function() {
		...
		var targeturl = 'http://fbsale.dinhkk.com/FBPage/removePage/?id=' + fb_page_id;
		$.ajax({
			type : 'get',
			url : targeturl,
			async: false,
	...
	$(document).on('click','.btnCancelPage',function() {
		var fb_page_id = $(this).parent().parent().attr('fb_page_id');
		var targeturl = 'http://fbsale.dinhkk.com/FBPage/unregisterPage/?id=' + fb_page_id;
		$.ajax({
			type : 'get',
			url : targeturl,
			async: false,
	...
	$(document).on('click','.btnRegPage',function() {
		var fb_page_id = $(this).parent().parent().attr('fb_page_id');
		var targeturl = 'http://fbsale.dinhkk.com/FBPage/registerPage/?id=' + fb_page_id;
		$.ajax({
			type : 'get',
			url : targeturl,
			async: false,
