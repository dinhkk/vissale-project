...
class StockBooksController extends AppController {
    ...
    public function index() {
        ...
        $this->setInit();
        $page_title = __('stock_book_title');
    ...
    protected function setInit() {
        ...
        $is_locked = Configure::read('fbsale.StockBooks.is_locked');
