                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="btn-group">
                            ...
                            <a class="btn purple" href="<?php echo Router::url(array('action' => 'refresh'), true) ?>"> <?php echo __('update_btn') ?>
                    ...
                    <tr id="search-form" class="ajax-search-form">
                        ...
                        <td>
                            ...
                            echo $this->Form->input('module', array(
                                ...
                                'label' => false,
                                'name' => 'module',
                                'value' => $this->request->query('module'),
                            ));
                            ?>
                        </td>
                        <td>
                    ...
                    <?php if (!empty($list_data)): ?>
                        <?php foreach ($list_data as $item): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo h($item[$model_class]['module']) ?></td>
