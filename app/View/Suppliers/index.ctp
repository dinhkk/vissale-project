                ...
                <thead>
                    <tr>
                        <?php if (!empty($list_data)): ?>
                            ...
                            <th><?php echo __('supplier_name') ?></th>
                            <th><?php echo __('supplier_phone') ?></th>
                            <th><?php echo __('supplier_note') ?></th>
                            <th><?php echo __('supplier_address') ?></th>
                            <th><?php echo __('supplier_tax_code') ?></th>
                            <th><?php echo __('supplier_email') ?></th>
                        <?php else: ?>
                            <th><?php echo __('operation') ?></th>
                            <th><?php echo __('supplier_id') ?></th>
                            <th><?php echo __('supplier_name') ?></th>
                    ...
                    <tr id="search-form" class="ajax-search-form">
                        ...
                        <td>
                            ...
                            echo $this->Form->input('tax_code', array(
                                ...
                                'label' => false,
                                'name' => 'name',
                                'value' => $this->request->query('tax_code'),
                            ));
                            ?>
                        </td>
                        <td>
                    ...
                    <?php if (!empty($list_data)): ?>
                        <?php foreach ($list_data as $item): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo h($item[$model_class]['id']) ?></td>
                                ...
                                <td><?php echo h($item[$model_class]['tax_code']) ?></td>
                                <td><?php echo h($item[$model_class]['email']) ?></td>
                            </tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            echo $this->Form->input('tax_code', array(
                                                'class' => 'form-control',
                                                'label' => __('supplier_tax_code'),
                                                'value' => $item[$model_class]['tax_code'],
                                            ));
                                            ?>
                                        </div>
                                        <div class="col-md-4">
