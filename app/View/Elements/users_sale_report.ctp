...
<head>
    ...
    <style>
        ...
        div#table_list table.list tr.head td.right{
            padding-right: 1px;
        }

        div#table_list table.list tr.list_row td.right span{
            display: inline-block;
            padding-right: 1em;
        }
...
<div id="table_list" style="width: 100%;">
    <table class="list" style="width: 100%; margin-top: 1em;">
        <tr class="head" style="width: 99%;">
            <td class="center" style="width: 10%;">UserName</td>
            <td class="center" style="width: 10%;">
                <span style="font-family: firefly, DejaVu Sans, sans-serif;">Họ Tên</span>
            </td>
        ...
        <tr class="list_row" style="width: 99%;">
            <td class="center" style="width: 10%;">UserName</td>
            <td class="center" style="width: 10%;">
                <span style="font-family: firefly, DejaVu Sans, sans-serif;">Nguyễn Văn A</span>
            </td>
            <td class="center" style="width: 5%;">
                <span>11</span>
            </td>
