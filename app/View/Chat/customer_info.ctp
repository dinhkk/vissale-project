<div style="float: left; margin-right: 20px; margin-left: 20px">
	<img id="customerImg" style="border-radius: 50%; width: 60px; height: 60px; margin: 5px 0px; background-color: #ccc;" src="http://graph.facebook.com/<?php echo $customer['FBCustomers']['fb_name']; ?>/picture?type=normal" />
</div>
