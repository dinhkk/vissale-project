<div id="comment" last="<?php echo $last_time; ?>">
	<?php if(is_array($conversations)) foreach($conversations as $conv) { ?>
		<div
            class="list-group-item comment_item <?php if ($selected_conversation == $conv['Chat']['id']) echo 'seleted_comment' ?>"
		...
		<div class="row" style="padding: 15px;">
			...
			<div class="col-md-5">
				<p>
					<a class="chatName" href="<?php echo "https://facebook.com/{$conv['Chat']['fb_user_id']}"; ?>"
