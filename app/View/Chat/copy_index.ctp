...
?>
<section class="content" ng-controller="ChatController as $ctl">
				...
				<div class="row ontop" id="comment_filter">
					...
					<div class="col-md-3">
						<div class="input-group input-group">
							...
							<div class="btn-group">
								<a class="btn btn-default btn-flat dropdown-toggle btn-select2" data-toggle="dropdown"
								   href="#" id="selected_page" data-id="all">Tất Cả <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="#" class="select_page" data-id="all"> Tất Cả </a></li>
									<?php foreach($pages as $page) { ?>
									<li><a class="select_page" href="#"
										   data-id="<?php echo $page['FBPage']['id']; ?>"><?php echo $page['FBPage']['page_name']; ?></a>
									</li>
									<?php } ?>
								</ul>
							</div>
							...
							<div class="list-group-item comment_item"
								...
								<div class="row" style="padding: 15px;">
									...
									<div class="col-md-5">
										<p>
											<a class="chatName"
											   href="<?php echo " https://facebook.com/{$conv['Chat']['fb_user_id']}";
											?>"
