...
--
-- Host: localhost
-- Generation Time: Mar 23, 2016 at 01:48 PM
...
INSERT INTO `fb_post_comments` (`id`, `type`, `group_id`, `fb_customer_id`, `fb_page_id`, `page_id`, `fb_post_id`, `post_id`, `comment_id`, `content`, `parent_comment_id`, `status`, `user_created`, `created`, `modified`) VALUES
