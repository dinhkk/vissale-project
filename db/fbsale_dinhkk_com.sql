...
--
-- Host: localhost
-- Generation Time: Mar 23, 2016 at 10:06 AM
...
--
CREATE DATABASE IF NOT EXISTS `fbsale_dinhkk_com` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
--
-- Table structure for table `fb_chats`
--

DROP TABLE IF EXISTS `fb_chats`;
...
--
-- Dumping data for table `fb_chats`
--

INSERT INTO `fb_chats` (`id`, `type`, `group_id`, `fb_customer_id`, `fb_page_id`, `page_id`, `fb_post_id`, `post_id`, `comment_id`, `content`, `parent_comment_id`, `status`, `user_created`, `created`, `modified`) VALUES
(1, 0, 1, 1, 6, '734899429950601', 2, '734899429950601_739601006147110', '739601006147110_947477925359416', '1 ty likes :D 0966496489', '0', 0, NULL, '2016-03-22 20:22:03', '2016-03-22 20:22:03'),
(2, 0, 1, 1, 6, '734899429950601', 2, '734899429950601_739601006147110', '739601006147110_947473955359813', 'lam phat 1tr like xem sao 0966496489', '0', 0, NULL, '2016-03-22 20:22:05', '2016-03-22 20:22:05');
...
(1, 'load_post_limit', 3, NULL, '10', '2016-03-22 00:42:22', '2016-03-22 00:42:22'),
(1, 'fb_limit_comment_post', 3, NULL, '20', '2016-03-22 00:42:22', '2016-03-22 00:42:22'),
...
(1, 'fb_graph_limit_message_conversation', 3, NULL, '20', '2016-03-23 09:59:40', '2016-03-23 09:59:40');
...
(2, 1, '734899429950601', '734899429950601_739601006147110', 6, 2, NULL, 1, 1, 'từ từ để gọi', 'để lại SĐT rồi nói chuyện', 1, 1458652906, 1458584849, 0, 0, NULL, 0, '2016-03-21 00:00:00', '2016-03-22 20:22:07');
...
CREATE TABLE `orders` (
  ...
  `fb_page_id` int(11) DEFAULT NULL,
  `fb_post_id` int(11) DEFAULT NULL,
  `fb_chat_id` int(11) DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `group_id`, `fb_customer_id`, `fb_page_id`, `fb_post_id`, `fb_chat_id`, `total_qty`, `code`, `postal_code`, `customer_name`, `mobile`, `telco_code`, `city`, `address`, `note1`, `note2`, `cancel_note`, `shipping_note`, `is_top_priority`, `is_send_sms`, `is_inner_city`, `shipping_service_id`, `bundle_id`, `status_id`, `price`, `discount_price`, `shipping_price`, `other_price`, `total_price`, `weight`, `duplicate_id`, `duplicate_note`, `user_confirmed`, `user_assigned`, `user_created`, `user_modified`, `confirmed`, `delivered`, `created`, `modified`) VALUES
...
ALTER TABLE `fb_blacklists`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `fb_chats`
--
ALTER TABLE `fb_chats`
